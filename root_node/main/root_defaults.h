/**
 * @file root_defaults.h
 * @brief Константы и дефолтные настройки ROOT узла
 *
 * ⚠️ ВАЖНО: Общие настройки (WiFi, Mesh ID, пароли) находятся в common/mesh_config.h
 */

#ifndef ROOT_DEFAULTS_H
#define ROOT_DEFAULTS_H
