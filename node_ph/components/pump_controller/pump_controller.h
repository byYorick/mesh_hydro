 ...
 * @brief Управление 2 перистальтическими насосами с PWM (pH UP/DOWN)
 */
 ...
 */
typedef enum {
    PUMP_PH_UP = 0,      // GPIO 2  - pH вверх
    PUMP_PH_DOWN = 1,    // GPIO 3  - pH вниз
    PUMP_MAX = 2
} pump_id_t;
 ...
 * 
 * Настраивает PWM на 2 GPIO (ESP32-C3)
 * 
